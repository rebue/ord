...
public interface OrdOrderDetailMapper extends MybatisBaseMapper<OrdOrderDetailMo, Long> {
    ...
    int modifyOrg(@Param("supplierId") long supplierId, @Param("deliverOrgId") long deliverOrgId,
    ...
    int updateActualAmountANDReturnState(@Param("id") Long id, @Param("newActualAmount") BigDecimal newActualAmount,
            @Param("oldActualAmount") BigDecimal oldActualAmount, @Param("returnState") Byte returnState,
            @Param("returnedState") Byte returnedState, @Param("realBuyPointTotal") BigDecimal realBuyPointTotal);
    ...
    int updateSupplierIdById(@Param("id") Long id, @Param("newSupplierId") Long newSupplierId,
            @Param("oldSupplierId") Long oldSupplierId);
    ...
    OrdOrderDetailMo getFirstBuyDetail(@Param("onlineSpecId") Long onlineSpecId,
            @Param("returned") ReturnStateDic returned, @Param("paid") OrderStateDic paid);
    ...
    int modifyDeliverAndSupplierByOnlineid(@Param("supplierId") Long supplierId,
            @Param("deliverOrgId") Long deliverOrgId, @Param("onlineId") Long onlineId);
    ...
    int updateBuyPointById(@Param("id") Long id, @Param("buyPoint") BigDecimal buyPoint,
            @Param("buyPointTotal") BigDecimal buyPointTotal);
    ...
    int updateIsDeliver(@Param("orderId") Long orderId, @Param("onlineId") Long onlineId,
            @Param("onlineSpecId") Long onlineSpecId);

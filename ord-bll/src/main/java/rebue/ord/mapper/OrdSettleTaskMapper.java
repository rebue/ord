...
public interface OrdSettleTaskMapper extends MybatisBaseMapper<OrdSettleTaskMo, Long> {
	...
	int updateSettleExecuteState(@Param("tradeType") Byte tradeType, @Param("orderId") Long orderId,
	...
	int cancelSettleTask(@Param("id") Long id, @Param("beforeState") Byte beforeState,

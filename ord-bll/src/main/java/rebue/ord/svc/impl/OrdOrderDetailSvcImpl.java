...
@Service
public class OrdOrderDetailSvcImpl extends MybatisBaseSvcImpl<OrdOrderDetailMo, java.lang.Long, OrdOrderDetailMapper>
	...
	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public int modifyActualAmountANDReturnState(Long id, BigDecimal newActualAmount, BigDecimal oldActualAmount, Byte returnState, Byte returnedState) {
	...
	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public int modifyReturnNumAndCashbackTotal(Long id, BigDecimal oldCashbackTotal, BigDecimal newCashbackTotal,
	 ...
	 */
	@Override
	public int modifyOrg(UpdateOrgTo to) {
		Long orderId=to.getId();

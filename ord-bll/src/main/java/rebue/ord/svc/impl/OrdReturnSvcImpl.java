...
public class OrdReturnSvcImpl extends MybatisBaseSvcImpl<OrdReturnMo, java.lang.Long, OrdReturnMapper> implements OrdReturnSvc {
    ...
    public AgreeToReturnRo agreeToReturn(OrdOrderReturnTo mo) {
        ...
        if (orderList.get(0).getOrderState() == OrderStateDic.CANCEL.getCode() || orderList.get(0).getOrderState() == OrderStateDic.ALREADY_PLACE_AN_ORDER.getCode()) {
        ...
        int modifyReturnCountAndCashBackTotalResult = ordOrderDetailSvc.modifyReturnCountAndCashBackTotal(orderDetailMo);
    ...
    public AgreeToARefundRo agreeToARefund(OrdOrderReturnTo to) {
        ...
        if (returnCode == null || orderId == null || orderDetailId == null || refundOpId == null || subtractCashback == null) {
        ...
        byte orderState = orderList.get(0).getOrderState();
        if (orderState == OrderStateDic.CANCEL.getCode() || orderState == OrderStateDic.ALREADY_PLACE_AN_ORDER.getCode()) {
        ...
        if (orderState == OrderStateDic.ALREADY_SIGN_IN.getCode() || orderState == OrderStateDic.ALREADY_SETTLEMENT.getCode()) {
    ...
    public ReceivedAndRefundedRo receivedAndRefunded(OrdOrderReturnTo to) {
        ...
        if (orderList.get(0).getOrderState() == OrderStateDic.ALREADY_SIGN_IN.getCode() || orderList.get(0).getOrderState() == OrderStateDic.ALREADY_SETTLEMENT.getCode()) {
    ...
    @Override
    public List<Map<String, Object>> selectReturningInfo(Map<String, Object> map) throws ParseException, IntrospectionException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    @Override
    public List<Map<String, Object>> selectReturnInfo(Map<String, Object> map) throws ParseException, IntrospectionException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        _log.info("查询用户退货中订单信息的参数为：{}", map.toString());
        List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();

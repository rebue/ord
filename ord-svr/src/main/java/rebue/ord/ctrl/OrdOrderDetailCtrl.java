...
public class OrdOrderDetailCtrl {
    ...
    PageInfo<OrdOrderDetailMo> list(OrdOrderDetailMo qo, @RequestParam("pageNum") int pageNum, @RequestParam("pageSize") int pageSize) {
        _log.info("list OrdOrderDetailMo:" + qo + ", pageNum = " + pageNum + ", pageSize = " + pageSize);
        if (pageSize > 50) {

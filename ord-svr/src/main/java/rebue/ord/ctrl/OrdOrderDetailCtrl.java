...
public class OrdOrderDetailCtrl {
    ...
    Ro add(@RequestBody final OrdOrderDetailMo mo) throws Exception {
    ...
    Ro modify(@RequestBody final OrdOrderDetailMo mo) throws Exception {
    ...
    PageInfo<OrdOrderDetailMo> list(final OrdOrderDetailMo mo, @RequestParam(value = "pageNum", required = false) Integer pageNum,
        ...
        final PageInfo<OrdOrderDetailMo> result = svc.list(mo, pageNum, pageSize);
    ...
    OrdOrderDetailMo getById(@RequestParam("id") final java.lang.Long id) {

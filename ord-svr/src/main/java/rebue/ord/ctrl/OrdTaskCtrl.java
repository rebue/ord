...
public class OrdTaskCtrl {
    ...
    Ro add(@RequestBody final OrdTaskMo mo) throws Exception {
     ...
     */
    @PutMapping("/ord/task")
    Ro modify(@RequestBody final OrdTaskMo mo) throws Exception {
    ...
    OrdTaskMo getById(@RequestParam("id") final java.lang.Long id) {

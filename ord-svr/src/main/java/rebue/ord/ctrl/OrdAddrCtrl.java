...
public class OrdAddrCtrl {
    ...
    OrdAddrMo getById(@RequestParam("id") final java.lang.Long id) {
    ...
    Map<String, Object> add(final OrdAddrMo vo) throws Exception {
        _log.info("添加用户收货地址的参数为：{}", vo.toString());
        final int result = svc.add(vo);
    ...
    Map<String, Object> modifyDef(final OrdAddrMo vo) throws Exception {
     ...
     */
    @PutMapping("/ord/addr")
    Map<String, Object> modify(final OrdAddrMo vo) {
     ...
     */
    @GetMapping("/ord/addr")
    List<OrdAddrMo> list(final OrdAddrMo qo) {
        _log.info("list OrdAddrMo:" + qo);
        final List<OrdAddrMo> result = svc.list(qo);

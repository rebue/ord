...
//	@Test
    ...
    public void shiftOrder() throws IOException {
        String url = hostUrl
                + "/ord/order/shift?payOrderId=621943715350446101&oldUserId=620162743843946560&newUserId=560723287034822657";
        String orderMo = OkhttpUtils.get(url);
        System.out.println(orderMo);
    }
    ...
    public void modifyInviteId() throws IOException {
        ...
        modifyInviteIdTo.setId(560764840357003264l);
        modifyInviteIdTo.setInviterId(561747469235388416l);
